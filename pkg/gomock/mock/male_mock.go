...
func (m *MockMale) Put(id int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Put", id)
	ret0, _ := ret[0].(error)
	return ret0
}

// Put indicates an expected call of Put
func (mr *MockMaleMockRecorder) Put(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Put", reflect.TypeOf((*MockMale)(nil).Put), id)
}
