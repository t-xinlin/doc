...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_helloworld_84a71939826abe14, []int{0}
}
...
func (*HelloReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_helloworld_84a71939826abe14, []int{1}
}
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	//err := grpc.Invoke(ctx, "/pb.Greeter/SayHello", in, out, opts...)
...
func init() { proto.RegisterFile("helloworld.proto", fileDescriptor_helloworld_84a71939826abe14) }

var fileDescriptor_helloworld_84a71939826abe14 = []byte{
